...
export const googleSheetSettingsApi = {
  ...
  replaceCredential: (input: { credential: string; version: number }) => request<{ settings: GoogleSheetSettingsStatus; test: GoogleSheetConnectionTestResult }>('/credential', { method: 'PUT', body: JSON.stringify(input) }),
