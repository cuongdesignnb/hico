...
const VariantSourceSelector = ({ operation, variant, offers, offersLoading, onChange }: VariantSourceSelectorProps) => {
  const sourceModes = getCompatibleSources(operation);
  ...
  return (
    <div className="product-wizard-source-selector">
      <div className="product-wizard-source-grid">
