const TYPES = new Set(['ORDER_CREATED', 'ORDER_STATUS_CHANGED', 'ESIM_PROVISIONED', 'ESIM_PENDING_QR', 'PHYSICAL_SIM_SHIPPED', 'TOPUP_COMPLETED', 'LOYALTY_EARNED', 'LOYALTY_REVERSED', 'REFERRAL_APPLIED', 'REFERRAL_QUALIFIED', 'REFERRAL_REWARD', 'SECURITY_EVENT', 'SUPPORT_TICKET_CREATED', 'SUPPORT_REPLY_RECEIVED', 'SUPPORT_STATUS_CHANGED', 'SUPPORT_TICKET_CLOSED', 'SECURITY_PROFILE_CHANGED', 'SECURITY_PASSWORD_CHANGED', 'SECURITY_SESSION_REVOKED']);
