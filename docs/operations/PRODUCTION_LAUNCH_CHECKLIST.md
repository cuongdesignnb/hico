...
| CUS-01 | Customer security | Verified customer auth with independent customer session/CSRF boundary | Critical | IN_PROGRESS | PR15.1 migration 006, PR15.7 security/profile foundation, API/unit tests, and isolated two-instance Docker QA | Customer Platform owner | - | 2026-08-02 | Real production delivery, readiness endpoint, and approval evidence remain required; feature flags stay fail-closed |
...
| CUS-03 | Customer dashboard | Persisted owner-scoped dashboard with no mock sensitive data | Critical | BLOCKED | PR15.0/PR15.7 inventory; PR15.3 dashboard and API proof required | Customer Platform owner | - | - | Current legacy mock findings remain; PR15.7 account pages do not waive the PR15.3 dashboard gate |
